...
# This stays always
echo '<table class= "outer_table_opacityz" border="0" width="100%" cellspacing="0" cellpadding="0">';
echo '<tr>';
echo '<td>';
...
echo '<table class="banner_left" border="0" width="485" height="111">';
echo '<tr>';
...
echo '<table class="banner_right" border="0" width="485" height="111">';
echo '<tr>';
