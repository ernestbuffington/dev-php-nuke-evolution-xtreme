...
/*=======================================================================
 Nuke-Evolution Xtreme Dev 4: Enhanced PHP-Nuke Web Portal System
 =======================================================================*/
/************************************************************************
  Nuke-Evolution: Advanced Installer
  ============================================
  Copyright (c) 2010 by The Nuke-Evolution Xtreme Team
...
$install_lang['sql_install'] = "Importing Nuke-Evolution Xtreme Database";
$install_lang['sql2_install'] = "Importing Nuke-Evolution Xtreme IP to Country Database";

$install_lang['sql_install_success'] = "Importing Nuke-Evolution Xtreme Database Successful";
$install_lang['sql2_install_success'] = "Importing Nuke-Evolution Xtreme IP to Country Database Successful";
...
$install_lang['done'] = "Thank you for choosing Nuke-Evolution Xtreme.<br /><br /><a href=index.php>Goto your homepage</a>";
...
$install_lang['safe_mode'] = "Your php is currently in safe mode.<br /><br />This will keep the installer from finishing.<br /><br />You must install Nuke-Evolution Xtreme manually.<br /><br />Please see the install help file to manually install.";
