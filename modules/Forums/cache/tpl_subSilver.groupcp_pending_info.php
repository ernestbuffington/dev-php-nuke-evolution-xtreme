...
?>
    <tr> 
      ...
      <td class="<?php echo isset($pending_members_row_item['ROW_CLASS']) ? $pending_members_row_item['ROW_CLASS'] : ''; ?>" align="center"><span class="gen"><?php echo isset($pending_members_row_item['FROM']) ? $pending_members_row_item['FROM'] : ''; ?></span></td>
