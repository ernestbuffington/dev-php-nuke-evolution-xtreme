...
if($xml)
{
	...
	<!--Google Site Map File Generated by Site_Map http://www.86it.us -->
	...
	switch($link) {
		...
		case 'Blog_Topics':
			...
			while ($row9 = $db->sql_fetchrow($result9)) {
				...
				echo"<tr><td>&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"modules/Site_Map/images/cat2.gif\" alt=\"cat2\"> <a href=\"modules.php?name=Blog_Topics&amp;cid=$cidtopic\">$topiclink</a></td>";
				if($xml)
		        {
                    //XML
		...
		case 'Blog':
			...
			while ($row10 = $db->sql_fetchrow($result8)) {
				...
				echo"<tr><td>&nbsp;</td><td>&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"modules/Site_Map/images/cat2.gif\" alt=\"cat2\"> <a href=\"modules.php?name=Blog&amp;file=article&amp;sid=$cidnews\">$newslink</a></td>";
				if($xml)
		        {
                //XML
